...
import br.com.zup.beagle.core.BeagleCoreContextMoshi
import br.com.zup.beagle.core.context.tokenizer.ExpressionToken
import br.com.zup.beagle.core.context.tokenizer.ExpressionTokenExecutor
...
internal class ContextDataEvaluation(
    ...
    private val moshi: Moshi = BeagleCoreContextMoshi.moshi
) {
